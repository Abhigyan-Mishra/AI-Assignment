from MI.G.utility import predictions
import numpy as np
...
def q_f(data, qubo):
    ...
    return (best_result, round(E, 4), sum(best_result), iteration, end_time - start_time, replacement_count, migration_count, acc, mutation_count, results)  
